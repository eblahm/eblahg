...
//    $('#ptrig').popover({content:my_html, html:true});
    ...
    $("#sidebar_inner").html('<a href="' + random_picture_path + '"><img id="unique_pic" src="/pic/sbar?k=' + random_picture_key + '&h=' + sheight + '&w=' + swidth + '"></a>');
    if (window.screen.width > 768) {$("#unique_pic").css("width", swidth);}
});